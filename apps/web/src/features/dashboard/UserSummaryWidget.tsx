...
export function UserSummaryWidget() {
  ...
  return (
    ...
    >
      <div
        className="h-24 rounded-md bg-[radial-gradient(circle_at_18%_20%,var(--color-gj-orange),transparent_32%),radial-gradient(circle_at_78%_30%,var(--color-gj-cyan),transparent_28%),linear-gradient(135deg,var(--color-gj-brand-700),var(--color-gj-primary-600))]"
        aria-hidden="true"
      />
